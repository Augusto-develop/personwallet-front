...
export const FATURAS: Fatura[] = [
  {
    ...
    contas: [
      {
        idconta: 'VESTUARIO', descricao: 'Riachuelo',
  ...
  { contas: [{descricao: 'Posto Mack IV', idconta: 'COMBUSTIVEL', parcela: '', valor: 'R$ 50,00', vencimento: '13/04/2021' }], 
    idcarteira: 'DEBITO/A VISTA', status: 'Pago', valor: 'R$ 250,00', vencimento: '10/05/2021', 
  },
];
